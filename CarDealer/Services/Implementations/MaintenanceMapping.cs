...
internal static class MaintenanceMapping
{
    ...
    public static MaintenanceDebtItemDto ToDebtItem(Maintenance maintenance)
    {
    ...
    public static Transaction ToPaymentTransaction(Maintenance maintenance, MaintenancePayment payment) =>
        new()
        {
            Type = "Expense",
